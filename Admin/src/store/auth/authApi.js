...
export const authApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getProviders: builder.query({
            ...
            providesTags: (result) => (result ? [...result.map(({ id }) => ({ type: 'provider', id })), { type: 'provider', id: 'LIST' }] : [{ type: 'provider', id: 'LIST' }]),
        }),
        ...
        getUsers: builder.query({
            ...
            providesTags: (result) => (result ? [...result.map(({ id }) => ({ type: 'users', id })), { type: 'users', id: 'LIST' }] : [{ type: 'users', id: 'LIST' }]),
        }),
