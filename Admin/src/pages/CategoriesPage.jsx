      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {categorySnapshot.map((category) => (
          <Card key={category.title} className="p-5">
            <p className="text-xs uppercase tracking-wide text-slate-500">{category.title}</p>
            <p className="mt-3 text-3xl font-semibold text-slate-900">{category.products.toLocaleString()}</p>
      ...
      <Card>
        <div className="flex items-center justify-between">
          <div>
            ...
            <h3 className="text-xl font-semibold text-slate-900">Quick forms</h3>
          </div>
        </div>
